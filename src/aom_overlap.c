...
#define __PYX_HAVE__src__aom_overlap
#define __PYX_HAVE_API__src__aom_overlap
/* Early includes */
#include "mulliken_functions.h"
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
#include <stdio.h>
...
/* Module declarations from 'src.aom_overlap' */
...
static CYTHON_INLINE double __pyx_f_3src_11aom_overlap__AOM_overlap_calculation(int, int, int, int, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
static CYTHON_INLINE __Pyx_memviewslice __pyx_f_3src_11aom_overlap__calculate_overlap_S_matrix(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
...
#define __Pyx_MODULE_NAME "src.aom_overlap"
extern int __pyx_module_is_main_src__aom_overlap;
int __pyx_module_is_main_src__aom_overlap = 0;

/* Implementation of 'src.aom_overlap' */
...
static const char __pyx_k_STOs[] = "STOs";
...
static const char __pyx_k_istop[] = "istop";
...
static const char __pyx_k_s_matrix[] = "s_matrix";
...
static const char __pyx_k_STO_matrix[] = "STO_matrix";
static const char __pyx_k_ValueError[] = "ValueError";
static const char __pyx_k_pyx_result[] = "__pyx_result";
static const char __pyx_k_pyx_vtable[] = "__pyx_vtable__";
static const char __pyx_k_MemoryError[] = "MemoryError";
static const char __pyx_k_PickleError[] = "PickleError";
static const char __pyx_k_STO_id_array[] = "STO_id_array";
static const char __pyx_k_STO_mu_array[] = "STO_mu_array";
static const char __pyx_k_pyx_checksum[] = "__pyx_checksum";
static const char __pyx_k_stringsource[] = "stringsource";
static const char __pyx_k_pyx_getbuffer[] = "__pyx_getbuffer";
static const char __pyx_k_reduce_cython[] = "__reduce_cython__";
static const char __pyx_k_STO_type_array[] = "STO_type_array";
static const char __pyx_k_View_MemoryView[] = "View.MemoryView";
static const char __pyx_k_allocate_buffer[] = "allocate_buffer";
static const char __pyx_k_dtype_is_object[] = "dtype_is_object";
static const char __pyx_k_pyx_PickleError[] = "__pyx_PickleError";
static const char __pyx_k_setstate_cython[] = "__setstate_cython__";
static const char __pyx_k_src_aom_overlap[] = "src.aom_overlap";
static const char __pyx_k_pyx_unpickle_Enum[] = "__pyx_unpickle_Enum";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_strided_and_direct[] = "<strided and direct>";
static const char __pyx_k_src_aom_overlap_pyx[] = "src/aom_overlap.pyx";
static const char __pyx_k_strided_and_indirect[] = "<strided and indirect>";
static const char __pyx_k_contiguous_and_direct[] = "<contiguous and direct>";
static const char __pyx_k_MemoryView_of_r_object[] = "<MemoryView of %r object>";
static const char __pyx_k_AOM_overlap_calculation[] = "AOM_overlap_calculation";
static const char __pyx_k_MemoryView_of_r_at_0x_x[] = "<MemoryView of %r at 0x%x>";
static const char __pyx_k_contiguous_and_indirect[] = "<contiguous and indirect>";
static const char __pyx_k_Cannot_index_with_type_s[] = "Cannot index with type '%s'";
static const char __pyx_k_Invalid_shape_in_axis_d_d[] = "Invalid shape in axis %d: %d.";
static const char __pyx_k_calculate_overlap_S_matrix[] = "calculate_overlap_S_matrix";
...
static PyObject *__pyx_n_s_AOM_overlap_calculation;
...
static PyObject *__pyx_n_s_STO_id_array;
static PyObject *__pyx_n_s_STO_matrix;
static PyObject *__pyx_n_s_STO_mu_array;
static PyObject *__pyx_n_s_STO_type_array;
static PyObject *__pyx_n_s_STOs;
...
static PyObject *__pyx_n_s_calculate_overlap_S_matrix;
...
static PyObject *__pyx_n_s_s_matrix;
static PyObject *__pyx_n_s_setstate;
static PyObject *__pyx_n_s_setstate_cython;
static PyObject *__pyx_n_s_shape;
static PyObject *__pyx_n_s_size;
static PyObject *__pyx_n_s_src_aom_overlap;
static PyObject *__pyx_kp_s_src_aom_overlap_pyx;
...
static PyObject *__pyx_pf_3src_11aom_overlap_AOM_overlap_calculation(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_istart, int __pyx_v_istop, int __pyx_v_jstart, int __pyx_v_jstop, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_y, __Pyx_memviewslice __pyx_v_z, __Pyx_memviewslice __pyx_v_STO_id_array, __Pyx_memviewslice __pyx_v_STO_type_array, __Pyx_memviewslice __pyx_v_STO_mu_array, __Pyx_memviewslice __pyx_v_STO_matrix); /* proto */
static PyObject *__pyx_pf_3src_11aom_overlap_2calculate_overlap_S_matrix(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_y, __Pyx_memviewslice __pyx_v_z, int __pyx_v_STOs, __Pyx_memviewslice __pyx_v_STO_id_array, __Pyx_memviewslice __pyx_v_STO_type_array, __Pyx_memviewslice __pyx_v_STO_mu_array); /* proto */
...
static CYTHON_INLINE double __pyx_f_3src_11aom_overlap__AOM_overlap_calculation(int __pyx_v_istart, int __pyx_v_istop, int __pyx_v_jstart, int __pyx_v_jstop, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_y, __Pyx_memviewslice __pyx_v_z, __Pyx_memviewslice __pyx_v_STO_id_array, __Pyx_memviewslice __pyx_v_STO_type_array, __Pyx_memviewslice __pyx_v_STO_mu_array, __Pyx_memviewslice __pyx_v_STO_matrix) {
  double __pyx_v_S;
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_locali;
  ...
  __Pyx_RefNannySetupContext("_AOM_overlap_calculation", 0);

  /* "src/aom_overlap.pyx":18
 ...
 */
    __pyx_t_4 = __pyx_v_i;
    __pyx_v_locali = __Pyx_mod_long(((*((int *) ( /* dim=0 */ (__pyx_v_STO_type_array.data + __pyx_t_4 * __pyx_v_STO_type_array.strides[0]) ))) - 2), 4);

    /* "src/aom_overlap.pyx":23
 *     for i in range(istart,istop):
 *         locali=(STO_type_array[i]-2)%4
 *         for j in range(jstart,jstop):             # <<<<<<<<<<<<<<
 *             localj=(STO_type_array[j]-2)%4
 ...
 */
    __pyx_t_5 = __pyx_v_jstop;
    __pyx_t_6 = __pyx_t_5;
    for (__pyx_t_7 = __pyx_v_jstart; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
      __pyx_v_j = __pyx_t_7;

      /* "src/aom_overlap.pyx":24
 *         locali=(STO_type_array[i]-2)%4
 *         for j in range(jstart,jstop):
 *             localj=(STO_type_array[j]-2)%4             # <<<<<<<<<<<<<<
 *             if locali>0 and localj>0:
 ...
 */
      __pyx_t_4 = __pyx_v_j;
      __pyx_v_localj = __Pyx_mod_long(((*((int *) ( /* dim=0 */ (__pyx_v_STO_type_array.data + __pyx_t_4 * __pyx_v_STO_type_array.strides[0]) ))) - 2), 4);

      /* "src/aom_overlap.pyx":25
 *         for j in range(jstart,jstop):
 *             localj=(STO_type_array[j]-2)%4
 *             if locali>0 and localj>0:             # <<<<<<<<<<<<<<
 *                 if STO_id_array[i]!=STO_id_array[j]:
 ...
 */
      __pyx_t_9 = ((__pyx_v_locali > 0) != 0);
      if (__pyx_t_9) {
      } else {
        __pyx_t_8 = __pyx_t_9;
        goto __pyx_L8_bool_binop_done;
      }
      __pyx_t_9 = ((__pyx_v_localj > 0) != 0);
      __pyx_t_8 = __pyx_t_9;
      __pyx_L8_bool_binop_done:;
      if (__pyx_t_8) {

        /* "src/aom_overlap.pyx":26
 *             localj=(STO_type_array[j]-2)%4
 *             if locali>0 and localj>0:
 *                 if STO_id_array[i]!=STO_id_array[j]:             # <<<<<<<<<<<<<<
 *                     S=S+STO_matrix[STO_id_array[i]-1, locali]*STO_matrix[STO_id_array[j]-1, localj]\
 ...
 */
        ...
        __pyx_t_8 = (((*((int *) ( /* dim=0 */ (__pyx_v_STO_id_array.data + __pyx_t_4 * __pyx_v_STO_id_array.strides[0]) ))) != (*((int *) ( /* dim=0 */ (__pyx_v_STO_id_array.data + __pyx_t_10 * __pyx_v_STO_id_array.strides[0]) )))) != 0);
        if (__pyx_t_8) {

          /* "src/aom_overlap.pyx":27
 *             if locali>0 and localj>0:
 *                 if STO_id_array[i]!=STO_id_array[j]:
 *                     S=S+STO_matrix[STO_id_array[i]-1, locali]*STO_matrix[STO_id_array[j]-1, localj]\             # <<<<<<<<<<<<<<
 *                         *overlap(x[STO_id_array[i]-1],y[STO_id_array[i]-1],z[STO_id_array[i]-1],
 ...
 */
          ...
          __pyx_t_4 = ((*((int *) ( /* dim=0 */ (__pyx_v_STO_id_array.data + __pyx_t_10 * __pyx_v_STO_id_array.strides[0]) ))) - 1);
          __pyx_t_11 = __pyx_v_locali;
          __pyx_t_12 = __pyx_v_j;
          __pyx_t_13 = ((*((int *) ( /* dim=0 */ (__pyx_v_STO_id_array.data + __pyx_t_12 * __pyx_v_STO_id_array.strides[0]) ))) - 1);
          __pyx_t_14 = __pyx_v_localj;

          /* "src/aom_overlap.pyx":28
 *                 if STO_id_array[i]!=STO_id_array[j]:
 *                     S=S+STO_matrix[STO_id_array[i]-1, locali]*STO_matrix[STO_id_array[j]-1, localj]\
 *                         *overlap(x[STO_id_array[i]-1],y[STO_id_array[i]-1],z[STO_id_array[i]-1],             # <<<<<<<<<<<<<<
 *                                  x[STO_id_array[j]-1],y[STO_id_array[j]-1],z[STO_id_array[j]-1],
 ...
 */
          ...
          __pyx_t_16 = ((*((int *) ( /* dim=0 */ (__pyx_v_STO_id_array.data + __pyx_t_15 * __pyx_v_STO_id_array.strides[0]) ))) - 1);
          __pyx_t_17 = __pyx_v_i;
          __pyx_t_18 = ((*((int *) ( /* dim=0 */ (__pyx_v_STO_id_array.data + __pyx_t_17 * __pyx_v_STO_id_array.strides[0]) ))) - 1);
          __pyx_t_19 = __pyx_v_i;
          __pyx_t_20 = ((*((int *) ( /* dim=0 */ (__pyx_v_STO_id_array.data + __pyx_t_19 * __pyx_v_STO_id_array.strides[0]) ))) - 1);

          /* "src/aom_overlap.pyx":29
 *                     S=S+STO_matrix[STO_id_array[i]-1, locali]*STO_matrix[STO_id_array[j]-1, localj]\
 *                         *overlap(x[STO_id_array[i]-1],y[STO_id_array[i]-1],z[STO_id_array[i]-1],
 *                                  x[STO_id_array[j]-1],y[STO_id_array[j]-1],z[STO_id_array[j]-1],             # <<<<<<<<<<<<<<
 *                                  STO_mu_array[i],STO_mu_array[j],
 ...
 */
          ...
          __pyx_t_22 = ((*((int *) ( /* dim=0 */ (__pyx_v_STO_id_array.data + __pyx_t_21 * __pyx_v_STO_id_array.strides[0]) ))) - 1);
          __pyx_t_23 = __pyx_v_j;
          __pyx_t_24 = ((*((int *) ( /* dim=0 */ (__pyx_v_STO_id_array.data + __pyx_t_23 * __pyx_v_STO_id_array.strides[0]) ))) - 1);
          __pyx_t_25 = __pyx_v_j;
          __pyx_t_26 = ((*((int *) ( /* dim=0 */ (__pyx_v_STO_id_array.data + __pyx_t_25 * __pyx_v_STO_id_array.strides[0]) ))) - 1);

          /* "src/aom_overlap.pyx":30
 *                         *overlap(x[STO_id_array[i]-1],y[STO_id_array[i]-1],z[STO_id_array[i]-1],
 *                                  x[STO_id_array[j]-1],y[STO_id_array[j]-1],z[STO_id_array[j]-1],
 *                                  STO_mu_array[i],STO_mu_array[j],             # <<<<<<<<<<<<<<
 *                                  STO_type_array[i],STO_type_array[j])
 ...
 *                                  x[STO_id_array[j]-1],y[STO_id_array[j]-1],z[STO_id_array[j]-1],
 */
          __pyx_v_S = (__pyx_v_S + (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_STO_matrix.data + __pyx_t_4 * __pyx_v_STO_matrix.strides[0]) ) + __pyx_t_11 * __pyx_v_STO_matrix.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_STO_matrix.data + __pyx_t_13 * __pyx_v_STO_matrix.strides[0]) ) + __pyx_t_14 * __pyx_v_STO_matrix.strides[1]) )))) * overlap((*((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_16 * __pyx_v_x.strides[0]) ))), (*((double *) ( /* dim=0 */ (__pyx_v_y.data + __pyx_t_18 * __pyx_v_y.strides[0]) ))), (*((double *) ( /* dim=0 */ (__pyx_v_z.data + __pyx_t_20 * __pyx_v_z.strides[0]) ))), (*((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_22 * __pyx_v_x.strides[0]) ))), (*((double *) ( /* dim=0 */ (__pyx_v_y.data + __pyx_t_24 * __pyx_v_y.strides[0]) ))), (*((double *) ( /* dim=0 */ (__pyx_v_z.data + __pyx_t_26 * __pyx_v_z.strides[0]) ))), (*((double *) ( /* dim=0 */ (__pyx_v_STO_mu_array.data + __pyx_t_27 * __pyx_v_STO_mu_array.strides[0]) ))), (*((double *) ( /* dim=0 */ (__pyx_v_STO_mu_array.data + __pyx_t_28 * __pyx_v_STO_mu_array.strides[0]) ))), (*((int *) ( /* dim=0 */ (__pyx_v_STO_type_array.data + __pyx_t_29 * __pyx_v_STO_type_array.strides[0]) ))), (*((int *) ( /* dim=0 */ (__pyx_v_STO_type_array.data + __pyx_t_30 * __pyx_v_STO_type_array.strides[0]) ))))));
 ...
 */
        /*else*/ {
          ...
          __pyx_t_8 = (((*((int *) ( /* dim=0 */ (__pyx_v_STO_type_array.data + __pyx_t_30 * __pyx_v_STO_type_array.strides[0]) ))) == (*((int *) ( /* dim=0 */ (__pyx_v_STO_type_array.data + __pyx_t_29 * __pyx_v_STO_type_array.strides[0]) )))) != 0);
          if (__pyx_t_8) {

            /* "src/aom_overlap.pyx":34
 *                 else:
 *                     if STO_type_array[i]==STO_type_array[j]:
 *                         S=S+STO_matrix[STO_id_array[i]-1, locali]*STO_matrix[STO_id_array[j]-1, localj]             # <<<<<<<<<<<<<<
 *     return S
 ...
 */
            __pyx_t_29 = __pyx_v_i;
            __pyx_t_30 = ((*((int *) ( /* dim=0 */ (__pyx_v_STO_id_array.data + __pyx_t_29 * __pyx_v_STO_id_array.strides[0]) ))) - 1);
            __pyx_t_28 = __pyx_v_locali;
            __pyx_t_27 = __pyx_v_j;
            __pyx_t_25 = ((*((int *) ( /* dim=0 */ (__pyx_v_STO_id_array.data + __pyx_t_27 * __pyx_v_STO_id_array.strides[0]) ))) - 1);
            __pyx_t_26 = __pyx_v_localj;
            __pyx_v_S = (__pyx_v_S + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_STO_matrix.data + __pyx_t_30 * __pyx_v_STO_matrix.strides[0]) ) + __pyx_t_28 * __pyx_v_STO_matrix.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_STO_matrix.data + __pyx_t_25 * __pyx_v_STO_matrix.strides[0]) ) + __pyx_t_26 * __pyx_v_STO_matrix.strides[1]) )))));
...
static CYTHON_INLINE __Pyx_memviewslice __pyx_f_3src_11aom_overlap__calculate_overlap_S_matrix(__Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_y, __Pyx_memviewslice __pyx_v_z, int __pyx_v_STOs, __Pyx_memviewslice __pyx_v_STO_id_array, __Pyx_memviewslice __pyx_v_STO_type_array, __Pyx_memviewslice __pyx_v_STO_mu_array) {
  __Pyx_memviewslice __pyx_v_Smatrix = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_i;
  int __pyx_v_j;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("_calculate_overlap_S_matrix", 0);

  /* "src/aom_overlap.pyx":44
 *         int[:] STO_type_array, double[:] STO_mu_array
 * ):
 ...
 */
  ...
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_identity); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_STOs); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = NULL;
  ...
  __pyx_v_Smatrix = __pyx_t_5;
  __pyx_t_5.memview = NULL;
  __pyx_t_5.data = NULL;

  /* "src/aom_overlap.pyx":46
 *     cdef double[:,:] Smatrix = np.identity(STOs)
 *     cdef int i, j
 *     for i in range(STOs):             # <<<<<<<<<<<<<<
 *         for j in range(STOs):
 ...
 */
  __pyx_t_6 = __pyx_v_STOs;
  __pyx_t_7 = __pyx_t_6;
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    __pyx_v_i = __pyx_t_8;

    /* "src/aom_overlap.pyx":47
 *     cdef int i, j
 *     for i in range(STOs):
 *         for j in range(STOs):             # <<<<<<<<<<<<<<
 *             if STO_id_array[i]!=STO_id_array[j] and i <= j:
 ...
 */
    __pyx_t_9 = __pyx_v_STOs;
    __pyx_t_10 = __pyx_t_9;
    for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
      __pyx_v_j = __pyx_t_11;

      /* "src/aom_overlap.pyx":48
 *     for i in range(STOs):
 *         for j in range(STOs):
 *             if STO_id_array[i]!=STO_id_array[j] and i <= j:             # <<<<<<<<<<<<<<
 *                 Smatrix[i, j] = overlap(x[STO_id_array[i]-1],y[STO_id_array[i]-1],z[STO_id_array[i]-1],x[STO_id_array[j]-1],y[STO_id_array[j]-1],z[STO_id_array[j]-1],STO_mu_array[i],STO_mu_array[j],STO_type_array[i],STO_type_array[j])
 ...
 */
      ...
      __pyx_t_15 = (((*((int *) ( /* dim=0 */ (__pyx_v_STO_id_array.data + __pyx_t_13 * __pyx_v_STO_id_array.strides[0]) ))) != (*((int *) ( /* dim=0 */ (__pyx_v_STO_id_array.data + __pyx_t_14 * __pyx_v_STO_id_array.strides[0]) )))) != 0);
      if (__pyx_t_15) {
      } else {
 ...
 */
        ...
        __pyx_t_13 = ((*((int *) ( /* dim=0 */ (__pyx_v_STO_id_array.data + __pyx_t_14 * __pyx_v_STO_id_array.strides[0]) ))) - 1);
        __pyx_t_16 = __pyx_v_i;
        __pyx_t_17 = ((*((int *) ( /* dim=0 */ (__pyx_v_STO_id_array.data + __pyx_t_16 * __pyx_v_STO_id_array.strides[0]) ))) - 1);
        __pyx_t_18 = __pyx_v_i;
        __pyx_t_19 = ((*((int *) ( /* dim=0 */ (__pyx_v_STO_id_array.data + __pyx_t_18 * __pyx_v_STO_id_array.strides[0]) ))) - 1);
        __pyx_t_20 = __pyx_v_j;
        __pyx_t_21 = ((*((int *) ( /* dim=0 */ (__pyx_v_STO_id_array.data + __pyx_t_20 * __pyx_v_STO_id_array.strides[0]) ))) - 1);
        __pyx_t_22 = __pyx_v_j;
        __pyx_t_23 = ((*((int *) ( /* dim=0 */ (__pyx_v_STO_id_array.data + __pyx_t_22 * __pyx_v_STO_id_array.strides[0]) ))) - 1);
        __pyx_t_24 = __pyx_v_j;
        __pyx_t_25 = ((*((int *) ( /* dim=0 */ (__pyx_v_STO_id_array.data + __pyx_t_24 * __pyx_v_STO_id_array.strides[0]) ))) - 1);
        ...
        *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_Smatrix.data + __pyx_t_30 * __pyx_v_Smatrix.strides[0]) ) + __pyx_t_31 * __pyx_v_Smatrix.strides[1]) )) = overlap((*((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_13 * __pyx_v_x.strides[0]) ))), (*((double *) ( /* dim=0 */ (__pyx_v_y.data + __pyx_t_17 * __pyx_v_y.strides[0]) ))), (*((double *) ( /* dim=0 */ (__pyx_v_z.data + __pyx_t_19 * __pyx_v_z.strides[0]) ))), (*((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_21 * __pyx_v_x.strides[0]) ))), (*((double *) ( /* dim=0 */ (__pyx_v_y.data + __pyx_t_23 * __pyx_v_y.strides[0]) ))), (*((double *) ( /* dim=0 */ (__pyx_v_z.data + __pyx_t_25 * __pyx_v_z.strides[0]) ))), (*((double *) ( /* dim=0 */ (__pyx_v_STO_mu_array.data + __pyx_t_26 * __pyx_v_STO_mu_array.strides[0]) ))), (*((double *) ( /* dim=0 */ (__pyx_v_STO_mu_array.data + __pyx_t_27 * __pyx_v_STO_mu_array.strides[0]) ))), (*((int *) ( /* dim=0 */ (__pyx_v_STO_type_array.data + __pyx_t_28 * __pyx_v_STO_type_array.strides[0]) ))), (*((int *) ( /* dim=0 */ (__pyx_v_STO_type_array.data + __pyx_t_29 * __pyx_v_STO_type_array.strides[0]) ))));
 ...
 * 
 */
  __PYX_INC_MEMVIEW(&__pyx_v_Smatrix, 0);
  __pyx_r = __pyx_v_Smatrix;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("src.aom_overlap._calculate_overlap_S_matrix", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  ...
  __pyx_L2:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_Smatrix, 1);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "src/aom_overlap.pyx":54
 * 
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_3src_11aom_overlap_1AOM_overlap_calculation(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_3src_11aom_overlap_1AOM_overlap_calculation = {"AOM_overlap_calculation", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_3src_11aom_overlap_1AOM_overlap_calculation, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_3src_11aom_overlap_1AOM_overlap_calculation(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_istart;
  int __pyx_v_istop;
  int __pyx_v_jstart;
  int __pyx_v_jstop;
  ...
  __Pyx_memviewslice __pyx_v_STO_id_array = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_STO_type_array = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_STO_mu_array = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_STO_matrix = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("AOM_overlap_calculation (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_istart,&__pyx_n_s_istop,&__pyx_n_s_jstart,&__pyx_n_s_jstop,&__pyx_n_s_x,&__pyx_n_s_y,&__pyx_n_s_z,&__pyx_n_s_STO_id_array,&__pyx_n_s_STO_type_array,&__pyx_n_s_STO_mu_array,&__pyx_n_s_STO_matrix,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_istart)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_istop)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("AOM_overlap_calculation", 1, 11, 11, 1); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_jstart)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("AOM_overlap_calculation", 1, 11, 11, 2); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_jstop)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("AOM_overlap_calculation", 1, 11, 11, 3); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_x)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("AOM_overlap_calculation", 1, 11, 11, 4); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_y)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("AOM_overlap_calculation", 1, 11, 11, 5); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_z)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("AOM_overlap_calculation", 1, 11, 11, 6); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_STO_id_array)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("AOM_overlap_calculation", 1, 11, 11, 7); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_STO_type_array)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("AOM_overlap_calculation", 1, 11, 11, 8); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  9:
        if (likely((values[9] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_STO_mu_array)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("AOM_overlap_calculation", 1, 11, 11, 9); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 10:
        if (likely((values[10] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_STO_matrix)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("AOM_overlap_calculation", 1, 11, 11, 10); __PYX_ERR(0, 54, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "AOM_overlap_calculation") < 0)) __PYX_ERR(0, 54, __pyx_L3_error)
      }
    ...
    __pyx_v_istart = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_istart == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 55, __pyx_L3_error)
    __pyx_v_istop = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_istop == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 55, __pyx_L3_error)
    __pyx_v_jstart = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_jstart == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 55, __pyx_L3_error)
    __pyx_v_jstop = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_jstop == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 55, __pyx_L3_error)
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 55, __pyx_L3_error)
    __pyx_v_y = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[5], PyBUF_WRITABLE); if (unlikely(!__pyx_v_y.memview)) __PYX_ERR(0, 55, __pyx_L3_error)
    __pyx_v_z = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[6], PyBUF_WRITABLE); if (unlikely(!__pyx_v_z.memview)) __PYX_ERR(0, 56, __pyx_L3_error)
    __pyx_v_STO_id_array = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[7], PyBUF_WRITABLE); if (unlikely(!__pyx_v_STO_id_array.memview)) __PYX_ERR(0, 56, __pyx_L3_error)
    __pyx_v_STO_type_array = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[8], PyBUF_WRITABLE); if (unlikely(!__pyx_v_STO_type_array.memview)) __PYX_ERR(0, 56, __pyx_L3_error)
    __pyx_v_STO_mu_array = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[9], PyBUF_WRITABLE); if (unlikely(!__pyx_v_STO_mu_array.memview)) __PYX_ERR(0, 57, __pyx_L3_error)
    __pyx_v_STO_matrix = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[10], PyBUF_WRITABLE); if (unlikely(!__pyx_v_STO_matrix.memview)) __PYX_ERR(0, 57, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("AOM_overlap_calculation", 1, 11, 11, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 54, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("src.aom_overlap.AOM_overlap_calculation", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_3src_11aom_overlap_AOM_overlap_calculation(__pyx_self, __pyx_v_istart, __pyx_v_istop, __pyx_v_jstart, __pyx_v_jstop, __pyx_v_x, __pyx_v_y, __pyx_v_z, __pyx_v_STO_id_array, __pyx_v_STO_type_array, __pyx_v_STO_mu_array, __pyx_v_STO_matrix);
...
static PyObject *__pyx_pf_3src_11aom_overlap_AOM_overlap_calculation(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_istart, int __pyx_v_istop, int __pyx_v_jstart, int __pyx_v_jstop, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_y, __Pyx_memviewslice __pyx_v_z, __Pyx_memviewslice __pyx_v_STO_id_array, __Pyx_memviewslice __pyx_v_STO_type_array, __Pyx_memviewslice __pyx_v_STO_mu_array, __Pyx_memviewslice __pyx_v_STO_matrix) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("AOM_overlap_calculation", 0);

  /* "src/aom_overlap.pyx":59
 *         double[:] STO_mu_array, double[:,:] STO_matrix
 * ):
 ...
 * 
 */
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_3src_11aom_overlap__AOM_overlap_calculation(__pyx_v_istart, __pyx_v_istop, __pyx_v_jstart, __pyx_v_jstop, __pyx_v_x, __pyx_v_y, __pyx_v_z, __pyx_v_STO_id_array, __pyx_v_STO_type_array, __pyx_v_STO_mu_array, __pyx_v_STO_matrix)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 59, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_STO_id_array, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_STO_type_array, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_STO_mu_array, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_STO_matrix, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "src/aom_overlap.pyx":63
 * 
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_3src_11aom_overlap_3calculate_overlap_S_matrix(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_3src_11aom_overlap_3calculate_overlap_S_matrix = {"calculate_overlap_S_matrix", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_3src_11aom_overlap_3calculate_overlap_S_matrix, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_3src_11aom_overlap_3calculate_overlap_S_matrix(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_x = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_y = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_z = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_STOs;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("calculate_overlap_S_matrix (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_x,&__pyx_n_s_y,&__pyx_n_s_z,&__pyx_n_s_STOs,&__pyx_n_s_STO_id_array,&__pyx_n_s_STO_type_array,&__pyx_n_s_STO_mu_array,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_y)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("calculate_overlap_S_matrix", 1, 7, 7, 1); __PYX_ERR(0, 63, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_z)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculate_overlap_S_matrix", 1, 7, 7, 2); __PYX_ERR(0, 63, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_STOs)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculate_overlap_S_matrix", 1, 7, 7, 3); __PYX_ERR(0, 63, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_STO_id_array)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculate_overlap_S_matrix", 1, 7, 7, 4); __PYX_ERR(0, 63, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_STO_type_array)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculate_overlap_S_matrix", 1, 7, 7, 5); __PYX_ERR(0, 63, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_STO_mu_array)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculate_overlap_S_matrix", 1, 7, 7, 6); __PYX_ERR(0, 63, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "calculate_overlap_S_matrix") < 0)) __PYX_ERR(0, 63, __pyx_L3_error)
      }
    ...
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 64, __pyx_L3_error)
    __pyx_v_y = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_y.memview)) __PYX_ERR(0, 64, __pyx_L3_error)
    __pyx_v_z = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_z.memview)) __PYX_ERR(0, 64, __pyx_L3_error)
    __pyx_v_STOs = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_STOs == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 64, __pyx_L3_error)
    __pyx_v_STO_id_array = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_STO_id_array.memview)) __PYX_ERR(0, 64, __pyx_L3_error)
    __pyx_v_STO_type_array = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[5], PyBUF_WRITABLE); if (unlikely(!__pyx_v_STO_type_array.memview)) __PYX_ERR(0, 65, __pyx_L3_error)
    __pyx_v_STO_mu_array = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[6], PyBUF_WRITABLE); if (unlikely(!__pyx_v_STO_mu_array.memview)) __PYX_ERR(0, 65, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("calculate_overlap_S_matrix", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 63, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("src.aom_overlap.calculate_overlap_S_matrix", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_3src_11aom_overlap_2calculate_overlap_S_matrix(__pyx_self, __pyx_v_x, __pyx_v_y, __pyx_v_z, __pyx_v_STOs, __pyx_v_STO_id_array, __pyx_v_STO_type_array, __pyx_v_STO_mu_array);
...
static PyObject *__pyx_pf_3src_11aom_overlap_2calculate_overlap_S_matrix(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_y, __Pyx_memviewslice __pyx_v_z, int __pyx_v_STOs, __Pyx_memviewslice __pyx_v_STO_id_array, __Pyx_memviewslice __pyx_v_STO_type_array, __Pyx_memviewslice __pyx_v_STO_mu_array) {
  PyObject *__pyx_v_s_matrix = NULL;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("calculate_overlap_S_matrix", 0);

  /* "src/aom_overlap.pyx":67
 *         int[:] STO_type_array, double[:] STO_mu_array
 * ):
 ...
 */
  __pyx_t_4 = __pyx_f_3src_11aom_overlap__calculate_overlap_S_matrix(__pyx_v_x, __pyx_v_y, __pyx_v_z, __pyx_v_STOs, __pyx_v_STO_id_array, __pyx_v_STO_type_array, __pyx_v_STO_mu_array); if (unlikely(!__pyx_t_4.memview)) __PYX_ERR(0, 67, __pyx_L1_error)
 ...
 *     ))
 */
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_t_4, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 67, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_s_matrix = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "src/aom_overlap.pyx":70
 *         x, y, z, STOs, STO_id_array, STO_type_array, STO_mu_array
 *     ))
 *     return s_matrix + s_matrix.T - np.diag(np.diag(s_matrix))             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_s_matrix, __pyx_n_s_T); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = PyNumber_Add(__pyx_v_s_matrix, __pyx_t_1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_np); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_diag); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_GetModuleGlobalName(__pyx_t_6, __pyx_n_s_np); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_diag); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 70, __pyx_L1_error)
  ...
  __pyx_t_2 = (__pyx_t_6) ? __Pyx_PyObject_Call2Args(__pyx_t_7, __pyx_t_6, __pyx_v_s_matrix) : __Pyx_PyObject_CallOneArg(__pyx_t_7, __pyx_v_s_matrix);
  ...
  __pyx_t_5 = PyNumber_Subtract(__pyx_t_3, __pyx_t_1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_r = __pyx_t_5;
 ...
 */
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_s_matrix);
  __PYX_XDEC_MEMVIEW(&__pyx_v_x, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_y, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_z, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_STO_id_array, 1);
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "src.aom_overlap.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "src.aom_overlap._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_aom_overlap(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_aom_overlap},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_n_s_AOM_overlap_calculation, __pyx_k_AOM_overlap_calculation, sizeof(__pyx_k_AOM_overlap_calculation), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_STO_id_array, __pyx_k_STO_id_array, sizeof(__pyx_k_STO_id_array), 0, 0, 1, 1},
  {&__pyx_n_s_STO_matrix, __pyx_k_STO_matrix, sizeof(__pyx_k_STO_matrix), 0, 0, 1, 1},
  {&__pyx_n_s_STO_mu_array, __pyx_k_STO_mu_array, sizeof(__pyx_k_STO_mu_array), 0, 0, 1, 1},
  {&__pyx_n_s_STO_type_array, __pyx_k_STO_type_array, sizeof(__pyx_k_STO_type_array), 0, 0, 1, 1},
  {&__pyx_n_s_STOs, __pyx_k_STOs, sizeof(__pyx_k_STOs), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_calculate_overlap_S_matrix, __pyx_k_calculate_overlap_S_matrix, sizeof(__pyx_k_calculate_overlap_S_matrix), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_s_matrix, __pyx_k_s_matrix, sizeof(__pyx_k_s_matrix), 0, 0, 1, 1},
  {&__pyx_n_s_setstate, __pyx_k_setstate, sizeof(__pyx_k_setstate), 0, 0, 1, 1},
  {&__pyx_n_s_setstate_cython, __pyx_k_setstate_cython, sizeof(__pyx_k_setstate_cython), 0, 0, 1, 1},
  {&__pyx_n_s_shape, __pyx_k_shape, sizeof(__pyx_k_shape), 0, 0, 1, 1},
  {&__pyx_n_s_size, __pyx_k_size, sizeof(__pyx_k_size), 0, 0, 1, 1},
  {&__pyx_n_s_src_aom_overlap, __pyx_k_src_aom_overlap, sizeof(__pyx_k_src_aom_overlap), 0, 0, 1, 1},
  {&__pyx_kp_s_src_aom_overlap_pyx, __pyx_k_src_aom_overlap_pyx, sizeof(__pyx_k_src_aom_overlap_pyx), 0, 0, 1, 0},
 ...
 *         double[:] z, int[:] STO_id_array, int[:] STO_type_array,
 */
  __pyx_tuple__19 = PyTuple_Pack(11, __pyx_n_s_istart, __pyx_n_s_istop, __pyx_n_s_jstart, __pyx_n_s_jstop, __pyx_n_s_x, __pyx_n_s_y, __pyx_n_s_z, __pyx_n_s_STO_id_array, __pyx_n_s_STO_type_array, __pyx_n_s_STO_mu_array, __pyx_n_s_STO_matrix); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__19);
  __Pyx_GIVEREF(__pyx_tuple__19);
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(11, 0, 11, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_aom_overlap_pyx, __pyx_n_s_AOM_overlap_calculation, 54, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) __PYX_ERR(0, 54, __pyx_L1_error)
 ...
 *         int[:] STO_type_array, double[:] STO_mu_array
 */
  __pyx_tuple__21 = PyTuple_Pack(8, __pyx_n_s_x, __pyx_n_s_y, __pyx_n_s_z, __pyx_n_s_STOs, __pyx_n_s_STO_id_array, __pyx_n_s_STO_type_array, __pyx_n_s_STO_mu_array, __pyx_n_s_s_matrix); if (unlikely(!__pyx_tuple__21)) __PYX_ERR(0, 63, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__21);
  __Pyx_GIVEREF(__pyx_tuple__21);
  __pyx_codeobj__22 = (PyObject*)__Pyx_PyCode_New(7, 0, 8, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__21, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_aom_overlap_pyx, __pyx_n_s_calculate_overlap_S_matrix, 63, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__22)) __PYX_ERR(0, 63, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initaom_overlap(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initaom_overlap(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_aom_overlap(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_aom_overlap(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_aom_overlap(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'aom_overlap' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_aom_overlap(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("aom_overlap", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_src__aom_overlap) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "src.aom_overlap")) {
      if (unlikely(PyDict_SetItemString(modules, "src.aom_overlap", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *         double[:] z, int[:] STO_id_array, int[:] STO_type_array,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_3src_11aom_overlap_1AOM_overlap_calculation, NULL, __pyx_n_s_src_aom_overlap); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_AOM_overlap_calculation, __pyx_t_1) < 0) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *         int[:] STO_type_array, double[:] STO_mu_array
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_3src_11aom_overlap_3calculate_overlap_S_matrix, NULL, __pyx_n_s_src_aom_overlap); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 63, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_calculate_overlap_S_matrix, __pyx_t_1) < 0) __PYX_ERR(0, 63, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "src/aom_overlap.pyx":1
 * cimport cython             # <<<<<<<<<<<<<<
 * import numpy as np
 * 
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init src.aom_overlap", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init src.aom_overlap");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
